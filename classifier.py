...
- **חולשה קיצונית + מחלה** (לא יכול/ה לקום מהמיטה בגלל מחלה) = **אדום**
...
- **כל מחלה שנמשכת 3 ימים או יותר** (שלשול, הקאות, חום, שיעול וכו') = **צהוב לפחות**
- **שלשול / הקאות / חום שנמשכים יומיים+ אצל קשיש** = **צהוב**
...
6. "שלושה ימים משלשלת כבר" → מחלה שנמשכת 3+ ימים = צהוב
7. "יש לי חום מאתמול ולא מרגישה טוב" → חום יומיים = צהוב
...
6. "חולה ממש חלשה לא יכולה לקום מהמיטה" → חולשה קיצונית + מחלה = דריסת אדום
